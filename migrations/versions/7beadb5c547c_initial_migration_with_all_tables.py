...
Revision ID: 7beadb5c547c
Revises: 
Create Date: 2026-07-11 15:51:46.861250
...
def upgrade():
    ...
    sa.Column('checked_week', sa.Integer(), nullable=True),
    sa.Column('checked_year', sa.Integer(), nullable=True),
